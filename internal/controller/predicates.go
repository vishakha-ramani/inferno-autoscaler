...
// ConfigMapPredicate returns a predicate that filters ConfigMap events to only the target ConfigMap.
// It checks that the ConfigMap name matches configMapName and namespace matches configMapNamespace.
